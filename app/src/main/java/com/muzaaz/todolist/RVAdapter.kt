            ...
            itemView.setOnClickListener {
                ...
                builder.setPositiveButton("Update") {
                    ...
                    itemView.context.database.use {
                        update(Model.TABLE_NAME, Model.NAMA to inputEdit.text.toString()).whereArgs("${Model.ID} = {id}", "id" to model.id!!.toLong())
                            .exec()

                        itemView.context.toast("Data Berhasil di Update")
